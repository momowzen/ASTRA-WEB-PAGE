...
export const HiddenClassCard = ({ hiddenClass, lang, index }: HiddenClassCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="glass rounded-2xl overflow-hidden gradient-border group hover:border-astra-primary/30 transition-all duration-300"
    >
      {/* Header */}
      <div className="p-5 border-b border-astra-primary/10 bg-gradient-to-r from-astra-primary/5 to-astra-secondary/5">
        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-astra-accent/20 to-astra-primary/20 border border-astra-primary/20 flex items-center justify-center text-2xl shadow-[0_0_15px_rgba(251,191,36,0.2)]">
            <Sparkles className="w-7 h-7 text-astra-accent" />
          </div>
          <div>
            <h3 className="text-xl font-bold text-astra-text font-display text-glow-gold">
